...
namespace Leap.Unity {
  ...
  * @since 4.1.2
  */
  public class JumpingMinionPalmDirectionDetector : Detector {
    /**
    ...
    */
    ...
    public void FixedUpdate () {
      if(HandModel != null && HandModel.IsTracked && Math.Abs(angleTo) > 105f) {
      ...
      if(HandModel != null && HandModel.IsTracked && Math.Abs(angleTo) < 83f) {
        minion.transform.eulerAngles = new Vector3(minion.transform.eulerAngles.x, 90, minion.transform.eulerAngles.z);
    ...
    //     Debug.Log("hand.PalmPosition.ToVector3() = " + hand.PalmPosition);
    //   }
    // }
        ...
        if(HandModel != null){
          ...
          if(hand != null){
            ...
            if(Math.Abs(angleTo) < 105 && Math.Abs(angleTo) > 83) {
              ...
              // Debug.Log("Activate -> angleTo = " + angleTo);
              Activate();
            }
          }
        }
